...
'''
palette = [0, 0, 0, 0, 255, 0, 255, 0, 0, 0, 0, 255, 255, 255, 0, 0, 255, 255]
...
def make_dataset(mode):
    ...
    if mode == "training":
        img_path = os.path.join(root, "orig_train")
        mask_path = os.path.join(root, "masks_train")
    elif mode == "validate":
        img_path = os.path.join(root, "orig_test")
        mask_path = os.path.join(root, "masks_test")
    else:
