...
num_classes = 2
ignore_label = 30
# root = 'C:\\Users\\hesko\\Desktop\\pytorch-semantic-segmentation\\hrf2'
root = "C:/Users/hesko/Desktop/segmentation_training_data"
#print(root)
'''
color map
...
def make_dataset(mode):
    ...
    if mode == "training":
        img_path = os.path.join(root, "training", "img")
        mask_path = os.path.join(root, "training", "masks")
    elif mode == "validate":
        img_path = os.path.join(root, "validate", "img")
        mask_path = os.path.join(root, "validate", "masks")
    else:
        img_path = os.path.join(root, "test", "images")
        mask_path = os.path.join(root, "test", "1st_manual")

    imgs = glob.glob(img_path + "/*.jpg")
    masks = glob.glob(mask_path + "/*.bmp")
    data = []
